...
Version `v3` for @akumzy/material-ui-pickers is coming with a whole bunch of breaking changes. This is a guide of how-to update :)
...
Please also note, that **v3** of `@akumzy/material-ui-pickers` relies on **v4** of `@material-ui/core`

```
npm i @akumzy/material-ui-pickers @material-ui/core@latest

yarn add @akumzy/material-ui-pickers @material-ui/core@latest
```
...
+ import { KeyboardDatePicker } from '@akumzy/material-ui-pickers'
...
```diff
- import { InlineDatePicker } from '@akumzy/material-ui-pickers'
+ import { DatePicker } from '@akumzy/material-ui-pickers'
