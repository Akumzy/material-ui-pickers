...
<PageMeta
  title="Installation"
  description="Step-by-step guide how to install @akumzy/material-ui-pickers"
/>

## Installation

Material UI Pickers is available as an [npm package](https://www.npmjs.com/package/@akumzy/material-ui-pickers):

```
npm i @akumzy/material-ui-pickers

yarn add @akumzy/material-ui-pickers
```

#### Peer Library

`@akumzy/material-ui-pickers` was designed to use the date management library of your choice.
...
import MomentUtils from '@akumzy/material-ui-pickers/adapter/moment';
import DateFnsUtils from '@akumzy/material-ui-pickers/adapter/date-fns';
import LuxonUtils from '@akumzy/material-ui-pickers/adapter/luxon';
